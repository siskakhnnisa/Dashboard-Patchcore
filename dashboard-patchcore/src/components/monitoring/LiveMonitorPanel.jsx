    ...
    <div className={`live-monitor card ${hasAlert ? "alert-state" : ""}`}>
      ...
      <div className="monitor-header">
        <div className="monitor-header-left">
          ...
          <div className="monitor-meta">Camera Source: [{cameraSource}]</div>
          <div className="monitor-meta monitor-meta-sep">|</div>
          <div className="monitor-meta">
            Inference: [{inferenceOn ? "ON" : "OFF"}]
          </div>
          <div className="monitor-meta">FPS: {fpsDisplay}</div>
        </div>
      ...
      <div className="monitor-feed">
        ...
        {/* Bounding Boxes */}
        {inferenceOn &&
          detections.map((det) => <DetectionBox key={det.id} det={det} />)}
...
function RunwayBackground() {
  return (
    ...
    >
      ...
      {/* Runway surface */}
      <polygon
        points="300,170 500,170 780,450 20,450"
        fill="url(#runwayGrad)"
      />
      ...
      {[0, 1, 2, 3, 4, 5, 6, 7].map((i) => {
        ...
        return (
          <polygon
            key={i}
            points={`${cx1 - hw1},${y1} ${cx1 + hw1},${y1} ${cx2 + hw2},${y2} ${
              cx2 - hw2
            },${y2}`}
